...
// Scroll Direction
export const scrollDir = derived(scrollY, $scrollY => {
...
// Scroll Up
export const scrollUp = derived(scrollY, $scrollY => {
...
// Scroll Down
export const scrollDown = derived(scrollY, $scrollY => {
...
// Scroll Top
export const scrollTop = derived([scrollY], ([$scrollY]) => $scrollY <= 0)
